...
Financial_statement = (f"Hello {Name}!\n your capstone financial statement is as follows:\n Marketing Expenses = GHC {Marketing}\n Operational Expenses = GHC {Operational_Expenses}\n Customer Aquisition = GHC {Total_customer_Aquisition}\n Total amount allocated = GHC {Total_Amount}" )
